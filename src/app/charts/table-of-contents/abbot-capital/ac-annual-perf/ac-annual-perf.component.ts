...
@Component({
  selector: 'app-ac-annual-perf',
  templateUrl: './ac-annual-perf.component.html',
  styleUrls: ['./ac-annual-perf.component.css']
})
export class AcAnnualPerfComponent implements OnInit {
