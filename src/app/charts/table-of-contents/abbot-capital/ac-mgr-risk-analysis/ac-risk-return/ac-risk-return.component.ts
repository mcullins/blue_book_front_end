...
@Component({
  selector: 'app-ac-risk-return',
  templateUrl: './ac-risk-return.component.html',
  styleUrls: ['./ac-risk-return.component.css']
})
export class AcRiskReturnComponent implements OnInit {
    ...
    chartOptions = {
        chart: {
            ...
            events: {
                load: function () {
                    var label = this.renderer.label("+ Big PE Abbot")
                        .add();
