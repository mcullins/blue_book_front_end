...
@Component({
  selector: 'app-ccp-capture-ratio',
  templateUrl: './ccp-capture-ratio.component.html',
  styleUrls: ['./ccp-capture-ratio.component.css']
})
export class CcpCaptureRatioComponent implements OnInit {
