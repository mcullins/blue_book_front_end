...
@Component({
  selector: 'app-cip-annual-perf',
  templateUrl: './cip-annual-perf.component.html',
  styleUrls: ['./cip-annual-perf.component.css']
})
export class CipAnnualPerfComponent implements OnInit {
...
function drawRect(chart) {
    ...
    rect = chart.renderer.rect(365, chart.chartHeight - xAxis.bottom, 210, 25, 0)
        .attr({
            'stroke-width': 0,
            stroke: 'white',
            fill: 'white',
