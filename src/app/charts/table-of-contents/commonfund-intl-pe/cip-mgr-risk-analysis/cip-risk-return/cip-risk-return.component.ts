...
@Component({
  selector: 'app-cip-risk-return',
  templateUrl: './cip-risk-return.component.html',
  styleUrls: ['./cip-risk-return.component.css']
})
export class CipRiskReturnComponent implements OnInit {
    ...
    chartOptions = {
        chart: {
            ...
            events: {
                load: function () {
                    var label = this.renderer.label("+ Big CF Intl")
                        .add();
