...
@Component({
  selector: 'app-cp-long-term-perf',
  templateUrl: './cp-long-term-perf.component.html',
  styleUrls: ['./cp-long-term-perf.component.css']
})
export class CpLongTermPerfComponent implements OnInit {
    ...
    chartOptions = {
        chart: {
            ...
            events: {
                load: function () {
                    var label = this.renderer.label("\xb9 GDP Deflator +8% <br> \xb2 BigCFPEVIII")
                        .add();
        ...
        yAxis: [{
            ...
            tickPosition: 'inside',
            gridLineColor: 'transparent',
            tickPositions: [-15, -10, -5, 0, 5, 10, 15, 20, 25],
            title: {
                text: ''
            }
        }, {
