...
@Component({
  selector: 'app-cv-capture-ratio',
  templateUrl: './cv-capture-ratio.component.html',
  styleUrls: ['./cv-capture-ratio.component.css']
})
export class CvCaptureRatioComponent implements OnInit {
