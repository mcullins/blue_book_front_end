...
@Component({
  selector: 'app-nr-annual-perf',
  templateUrl: './nr-annual-perf.component.html',
  styleUrls: ['./nr-annual-perf.component.css']
})
export class NrAnnualPerfComponent implements OnInit {
    ...
    chartOptions = {
        ...
        xAxis: {
            ...
            labels: {
                ...
                formatter: function () {
                    if (this.value.id === 4 || this.value.id === 5) {
...
function drawRect2(chart) {
    ...
    var xAxis = chart.xAxis[0];
    rect = chart.renderer.rect(295, chart.chartHeight - xAxis.bottom, 140, 25, 0)
        .attr({
            'stroke-width': 0,
            stroke: '#02007c',
            fill: '#02007c',
...
function drawRect3(chart) {
    ...
    var xAxis = chart.xAxis[0];
    rect = chart.renderer.rect(435, chart.chartHeight - xAxis.bottom, 280, 25, 0)
        .attr({
            'stroke-width': 0,
            stroke: 'white',
            fill: 'white',
