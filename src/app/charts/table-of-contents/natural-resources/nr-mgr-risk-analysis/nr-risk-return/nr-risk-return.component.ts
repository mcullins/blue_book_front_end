...
@Component({
  selector: 'app-nr-risk-return',
  templateUrl: './nr-risk-return.component.html',
  styleUrls: ['./nr-risk-return.component.css']
})
export class NrRiskReturnComponent implements OnInit {
    ...
    chartOptions = {
        chart: {
            ...
            events: {
                load: function () {
                    var label = this.renderer.label("+ Big CF PE Na")
                        .add();
