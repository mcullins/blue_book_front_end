...
@Component({
  selector: 'app-sit-five-yr-ratio',
  templateUrl: './sit-five-yr-ratio.component.html',
  styleUrls: ['./sit-five-yr-ratio.component.css']
})
export class SitFiveYrRatioComponent implements OnInit {
